" This colorscheme is originally from https://github.com/CreaturePhil/vim-handmade-hero on github. I have just made a few tweaks to it. 
set background=dark
...
"#171716
let s:back = ['#161616', 0]
let s:default = ['#dab98f', 0]
"#dab98f

let s:imports = ['#05f0f3', 0]
...
hi VertSplit guifg=#161616 guibg=#dab98f
...
call s:HL('CursorLineNr', s:default, s:back)
...
call s:HL('Todo', s:default, s:back)
...
hi cCustomScope guifg=#dab98f
hi cCustomClass guifg=#dab98f
hi cCustomFunc guifg=#e38056

" Python
call s:HL('Imports', s:imports)
call s:HL('Normal', s:default)
hi! link pythonBuiltinFunc Statement
hi pythonFunction guifg=#c76f4a
hi! pythonBuiltin  guifg=#CD950C
hi! link pythonDecorator Statement
hi! link pythonInclude Imports
hi! link pythonImport Imports
...
hi EndOfBuffer guibg=#161616 guifg=#0f0f0f
